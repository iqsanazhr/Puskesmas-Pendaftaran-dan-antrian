<div class="min-h-screen relative flex items-center justify-center bg-slate-50 py-12 px-4 sm:px-6 lg:px-8"
    x-data="{ isRegister: false }">
    <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-xl transition-all duration-300">
        <!-- Toggle Switch -->
        <div class="relative flex bg-slate-200 p-1 rounded-xl">
            <div class="absolute w-1/2 h-full top-0 left-0 bg-white rounded-lg shadow-sm transition-transform duration-300 pointer-events-none"
        ...
        <div class="relative grid grid-cols-1">
            ...
            <!-- LOGIN FORM -->
            <div x-show="!isRegister" class="row-start-1 col-start-1"
                ...
                <form wire:submit.prevent="login" class="space-y-5">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input wire:model.defer="loginEmail" id="login-email" type="email" autocomplete="email"
                                required
    ...
    <!-- Footer decoration -->
    <div class="absolute bottom-0 w-full bg-slate-50 p-4 text-center border-t border-slate-100">
